...
public class EmployerApplicationRejectService implements AbstractUpdateService<Employer, Application> {
	...
	public void validate(final Request<Application> request, final Application entity, final Errors errors) {
		...
		boolean mandatoryJustification;

		//Rejected applications must have a mandatory justification

		mandatoryJustification = request.getModel().getString("justification").equals("");
		errors.state(request, !mandatoryJustification, "justification", "employer.application.error.justification");
